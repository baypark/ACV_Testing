...
WebUI.click(findTestObject('ACV APPS/ACV BACKEND/BACKEND - LOGOUT/button - admin profile'))

WebUI.delay(2)

WebUI.click(findTestObject('ACV APPS/ACV BACKEND/BACKEND - LOGOUT/button - logout'))
