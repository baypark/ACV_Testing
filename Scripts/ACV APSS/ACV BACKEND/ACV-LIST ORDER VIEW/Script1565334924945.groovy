...
//WebUI.openBrowser(GlobalVariable.ACV + '/backend/login')
//
//WebUI.delay(5)
//
...
//WebUI.delay(5)
//
//WebUI.verifyTextPresent('Hai, Selamat datang di halaman admin', false)
//
//WebUI.delay(3)
...
WebUI.executeJavaScript('$(".fa-search").eq("0").click()', [])

WebUI.delay(3)

WebUI.verifyTextPresent('Informasi Inspection', true)

WebUI.delay(2)

WebUI.executeJavaScript('$(".btn-secondary").eq("0").click()', [])